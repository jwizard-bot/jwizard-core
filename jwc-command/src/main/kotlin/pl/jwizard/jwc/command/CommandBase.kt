...
abstract class CommandBase(protected val commandEnvironment: CommandEnvironmentBean) {
	 ...
	 */
	protected fun createLinkFromFragment(fragment: AppProperty): String {
		val baseUrl = environmentBean.getProperty<String>(BotProperty.LINK_WEBSITE)
		val fragmentUrl = environmentBean.getProperty<String>(fragment)
		return fragmentUrl.format(baseUrl)
	}
	...
	protected fun createLinkButton(name: I18nActionSource, link: AppProperty, context: CommandContext) =
		createLinkButton(name, environmentBean.getProperty<String>(link), context)
