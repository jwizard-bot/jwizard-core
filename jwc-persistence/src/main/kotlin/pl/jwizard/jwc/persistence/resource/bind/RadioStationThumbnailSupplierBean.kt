...
import pl.jwizard.jwc.persistence.resource.LibraryClasspathRetrieverBean
 ...
 * stations. This bean uses [LibraryClasspathRetrieverBean] to retrieve the required resources from the classpath.
 *
 * @property libraryClasspathRetrieverBean Injected bean to manage the retrieval of classpath resources.
 * @author Miłosz Gilga
 */
@SingletonComponent
class RadioStationThumbnailSupplierBean(
	private val libraryClasspathRetrieverBean: LibraryClasspathRetrieverBean
	 ...
	 * appropriate thumbnail resource via [LibraryClasspathRetrieverBean].
	 *
	 ...
	 *         unavailable.
	 */
	override fun getThumbnailResource(radioStation: RadioStation) = libraryClasspathRetrieverBean.getObject(
		ResourceObject.RADIO_STATION,
		radioStation.textKey.fromCamelToDashCase
	)
}
