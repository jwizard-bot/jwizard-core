...
public enum BotCommandArgument {
    ...
    ADD_FROM_FILE_PLAYLIST_ARG      (1, BotCommand.ADD_FROM_FILE_PLAYLIST,      String.class,   OptionType.STRING,          "name-or-id",       true),
    ADD_TRACK_TO_PLAYLIST_ARG_1     (1, BotCommand.ADD_TRACK_TO_PLAYLIST,       String.class,   OptionType.STRING,          "name-or-id",       true),
    ADD_TRACK_TO_PLAYLIST_ARG_2     (2, BotCommand.ADD_TRACK_TO_PLAYLIST,       String.class,   OptionType.STRING,          "tracks-urls",      true),
    CHANGE_PLAYLIST_NAME_ARG_1      (1, BotCommand.CHANGE_PLAYLIST_NAME,        String.class,   OptionType.STRING,          "name-or-id",       true),
    CHANGE_PLAYLIST_NAME_ARG_2      (2, BotCommand.CHANGE_PLAYLIST_NAME,        String.class,   OptionType.STRING,          "new-name",         true),
    CLEAR_PLAYLIST_ARG              (1, BotCommand.CLEAR_PLAYLIST,              String.class,   OptionType.STRING,          "name-or-id",       true),
    CREATE_PLAYLIST_ARG             (1, BotCommand.CREATE_PLAYLIST,             String.class,   OptionType.STRING,          "playlist-name",    true),
    PLAY_FROM_PLAYLIST_ARG          (1, BotCommand.PLAY_FROM_PLAYLIST,          String.class,   OptionType.STRING,          "name-or-id",       true),
    MOVE_TRACK_IN_PLAYLIST_ARG_1    (1, BotCommand.MOVE_TRACK_IN_PLAYLIST,      String.class,   OptionType.STRING,          "name-or-id",       true),
    MOVE_TRACK_IN_PLAYLIST_ARG_2    (2, BotCommand.MOVE_TRACK_IN_PLAYLIST,      String.class,   OptionType.INTEGER,         "old-pos",          true),
    MOVE_TRACK_IN_PLAYLIST_ARG_3    (3, BotCommand.MOVE_TRACK_IN_PLAYLIST,      String.class,   OptionType.INTEGER,         "new-pos",          true),
    REMOVE_PLAYLIST_ARG             (1, BotCommand.REMOVE_PLAYLIST,             String.class,   OptionType.STRING,          "name-or-id",       true),
    REMOVE_TRACK_PLAYLIST_ARG_1     (1, BotCommand.REMOVE_TRACK_PLAYLIST,       String.class,   OptionType.STRING,          "name-or-id",       true),
    REMOVE_TRACK_PLAYLIST_ARG_2     (2, BotCommand.REMOVE_TRACK_PLAYLIST,       String.class,   OptionType.INTEGER,         "track-id",         true),
    SAVE_TRACK_PLAYLIST_ARG         (1, BotCommand.SAVE_TRACK_PLAYLIST,         String.class,   OptionType.STRING,          "name-or-id",       true),
    SET_PLAYLIST_VISIBILITY_ARG_1   (1, BotCommand.SET_PLAYLIST_VISIBILITY,     String.class,   OptionType.STRING,          "name-or-id",       true),
    SET_PLAYLIST_VISIBILITY_ARG_2   (2, BotCommand.SET_PLAYLIST_VISIBILITY,     String.class,   OptionType.STRING,          "visibility",       true),
    SHOW_MEMBER_PLAYLISTS_ARG       (1, BotCommand.SHOW_MEMBER_PLAYLISTS,       String.class,   OptionType.MENTIONABLE,     "member",           true),
    SHOW_PLAYLIST_CONTENT_ARG       (1, BotCommand.SHOW_PLAYLIST_CONTENT,       String.class,   OptionType.STRING,          "name-or-id",       true),
