 ...
 *
 * File name: TurnOnCommandCmd.java
...
public class TurnOnCommandCmd extends AbstractOwnerCommand {
    ...
    protected void doExecuteOwnerCommand(CommandEventWrapper event) {
        final String commandNameOrAlias = event.getArgumentAndParse(BotCommandArgument.TURN_ON_COMMAND_COMMAND_TAG);
