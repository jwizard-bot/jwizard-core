 ...
 *
 * File name: SetPlaylistVisibility.java
 * Last modified: 20/06/2023, 15:47
...
public class SetPlaylistVisibilityCmd extends AbstractPlaylistsCommand {

    SetPlaylistVisibilityCmd(
        ...
        super(BotCommand.SET_PLAYLIST_VISIBILITY, config, embedBuilder, handler, cacheableCommandStateDao);
    }
