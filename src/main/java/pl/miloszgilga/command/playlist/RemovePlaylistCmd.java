 ...
 *
 * File name: RemovePlaylistCmd.java
...
public class RemovePlaylistCmd extends AbstractPlaylistsCommand {
    ...
    RemovePlaylistCmd(
        ...
        super(BotCommand.REMOVE_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
