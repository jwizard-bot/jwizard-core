 ...
 *
 * File name: ClearPlaylistCmd.java
...
public class ClearPlaylistCmd extends AbstractPlaylistsCommand {
    ...
    ClearPlaylistCmd(
        ...
        super(BotCommand.CLEAR_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
