 ...
 *
 * File name: SaveCurrentTracksInPlaylistCmd.java
 * Last modified: 20/06/2023, 15:50
...
public class SaveCurrentTracksInPlaylistCmd extends AbstractPlaylistsCommand {

    SaveCurrentTracksInPlaylistCmd(
        ...
        super(BotCommand.SAVE_TRACK_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
