 ...
 *
 * File name: ShowPlaylistContentCmd.java
 * Last modified: 20/06/2023, 16:15
...
public class ShowPlaylistContentCmd extends AbstractPlaylistsCommand {

    ShowPlaylistContentCmd(
        ...
        super(BotCommand.SHOW_PLAYLIST_CONTENT, config, embedBuilder, handler, cacheableCommandStateDao);
    }
