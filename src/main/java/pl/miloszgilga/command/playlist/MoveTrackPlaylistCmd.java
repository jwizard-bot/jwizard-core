 ...
 *
 * File name: MoveTrackPlaylistCmd.java
...
public class MoveTrackPlaylistCmd extends AbstractPlaylistsCommand {

    MoveTrackPlaylistCmd(
        ...
        super(BotCommand.MOVE_TRACK_IN_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
