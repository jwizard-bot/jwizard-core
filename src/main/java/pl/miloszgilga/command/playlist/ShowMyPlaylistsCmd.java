 ...
 *
 * File name: ShowMyPlaylistsCmd.java
 * Last modified: 20/06/2023, 15:45
...
public class ShowMyPlaylistsCmd extends AbstractPlaylistsCommand {
    ...
    ShowMyPlaylistsCmd(
        ...
        super(BotCommand.SHOW_MY_PLAYLISTS, config, embedBuilder, handler, cacheableCommandStateDao);
    }
