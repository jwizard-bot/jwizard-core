 ...
 *
 * File name: LoadAndPlayPlaylistTracksCmd.java
...
public class LoadAndPlayPlaylistTracksCmd extends AbstractPlaylistsCommand {

    LoadAndPlayPlaylistTracksCmd(
        ...
        super(BotCommand.PLAY_FROM_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
