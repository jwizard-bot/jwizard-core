 ...
 *
 * File name: AddTracksFromFileToPlaylistCmd.java
 * Last modified: 20/06/2023, 15:49
...
public class AddTracksFromFileToPlaylistCmd extends AbstractPlaylistsCommand {

    AddTracksFromFileToPlaylistCmd(
        ...
        super(BotCommand.ADD_FROM_FILE_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
