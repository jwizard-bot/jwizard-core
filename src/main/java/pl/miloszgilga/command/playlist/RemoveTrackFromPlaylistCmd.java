 ...
 *
 * File name: RemoveTrackFromPlaylistCmd.java
 * Last modified: 20/06/2023, 15:48
...
public class RemoveTrackFromPlaylistCmd extends AbstractPlaylistsCommand {

    RemoveTrackFromPlaylistCmd(
        ...
        super(BotCommand.REMOVE_TRACK_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
