 ...
 *
 * File name: CreatePlaylistCmd.java
...
public class CreatePlaylistCmd extends AbstractPlaylistsCommand {
    ...
    CreatePlaylistCmd(
        ...
        super(BotCommand.CREATE_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
