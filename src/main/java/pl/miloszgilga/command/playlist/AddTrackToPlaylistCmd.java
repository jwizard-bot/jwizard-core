 ...
 *
 * File name: AddTrackToPlaylist.java
...
public class AddTrackToPlaylistCmd extends AbstractPlaylistsCommand {

    AddTrackToPlaylistCmd(
        ...
        super(BotCommand.ADD_TRACK_TO_PLAYLIST, config, embedBuilder, handler, cacheableCommandStateDao);
    }
