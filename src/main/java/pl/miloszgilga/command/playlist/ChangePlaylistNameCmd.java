 ...
 *
 * File name: ChangePlaylistNameCmd.java
...
public class ChangePlaylistNameCmd extends AbstractPlaylistsCommand {

    ChangePlaylistNameCmd(
        ...
        super(BotCommand.CHANGE_PLAYLIST_NAME, config, embedBuilder, handler, cacheableCommandStateDao);
    }
