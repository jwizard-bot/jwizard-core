...
public enum CommandLocaleSet implements IEnumerableLocaleSet {
    ...
    ADD_FROM_FILE_PLAYLIST_COMMAND_DESC             ("jwizard.command.description.AddFromFilePlaylist"),
    ADD_TRACK_TO_PLAYLIST_COMMAND_DESC              ("jwizard.command.description.AddTrackToPlaylist"),
    CHANGE_PLAYLIST_NAME_COMMAND_DESC               ("jwizard.command.description.ChangePlaylistName"),
    CLEAR_PLAYLIST_COMMAND_DESC                     ("jwizard.command.description.ClearPlaylist"),
    CREATE_PLAYLIST_COMMAND_DESC                    ("jwizard.command.description.CreatePlaylist"),
    PLAY_FROM_PLAYLIST_COMMAND_DESC                 ("jwizard.command.description.PlayFromPlaylist"),
    MOVE_TRACK_IN_PLAYLIST_COMMAND_DESC             ("jwizard.command.description.MoveTrackInPlaylist"),
    REMOVE_PLAYLIST_COMMAND_DESC                    ("jwizard.command.description.RemovePlaylist"),
    REMOVE_TRACK_PLAYLIST_COMMAND_DESC              ("jwizard.command.description.RemoveTrackPlaylist"),
    SAVE_TRACK_PLAYLIST_COMMAND_DESC                ("jwizard.command.description.SaveTrackPlaylist"),
    SET_PLAYLIST_VISIBILITY_COMMAND_DESC            ("jwizard.command.description.SetPlaylistVisibility"),
    SHOW_MEMBER_PLAYLISTS_COMMAND_DESC              ("jwizard.command.description.ShowMemberPlaylists"),
    SHOW_MY_PLAYLISTS_COMMAND_DESC                  ("jwizard.command.description.ShowMyPlaylists"),
    SHOW_PLAYLIST_SONGS_COMMAND_DESC                ("jwizard.command.description.ShowPlaylistSongs"),
