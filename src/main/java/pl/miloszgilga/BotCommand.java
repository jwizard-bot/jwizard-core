...
public enum BotCommand {
    ...
    ADD_FROM_FILE_PLAYLIST      ("addplfile",   true, List.of("apff"),         PLAYLIST,    ADD_FROM_FILE_PLAYLIST_COMMAND_DESC,        PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
    ADD_TRACK_TO_PLAYLIST       ("addpltrack",  true, List.of("apt"),          PLAYLIST,    ADD_TRACK_TO_PLAYLIST_COMMAND_DESC,         PLAYLIST_ID_OR_NAME_WITH_TRACK_URL_SYNTAX),
    CHANGE_PLAYLIST_NAME        ("modplname",   true, List.of("mpnm"),         PLAYLIST,    CHANGE_PLAYLIST_NAME_COMMAND_DESC,          PLAYLIST_ID_OR_NAME_WITH_NEW_NAME_ARG_SYNTAX),
    CLEAR_PLAYLIST              ("clrplaylist", true, List.of("clpl"),         PLAYLIST,    CLEAR_PLAYLIST_COMMAND_DESC,                PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
    CREATE_PLAYLIST             ("addplaylist", true, List.of("addpl"),        PLAYLIST,    CREATE_PLAYLIST_COMMAND_DESC,               PLAYLIST_NAME_ARG_SYNTAX),
    PLAY_FROM_PLAYLIST          ("playpl",      true, List.of("plpl"),         PLAYLIST,    PLAY_FROM_PLAYLIST_COMMAND_DESC,            PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
    MOVE_TRACK_IN_PLAYLIST      ("mvtrackpl",   true, List.of("mtpl"),         PLAYLIST,    MOVE_TRACK_IN_PLAYLIST_COMMAND_DESC,        PLAYLIST_ID_OR_NAME_WITH_POS_ARG_SYNTAX),
    REMOVE_PLAYLIST             ("rmplaylist",  true, List.of("rmpl"),         PLAYLIST,    REMOVE_PLAYLIST_COMMAND_DESC,               PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
    REMOVE_TRACK_PLAYLIST       ("rmtrackpl",   true, List.of("rtpl"),         PLAYLIST,    REMOVE_TRACK_PLAYLIST_COMMAND_DESC,         PLAYLIST_ID_OR_NAME_WITH_TRACK_ID_ARG_SYNTAX),
    SAVE_TRACK_PLAYLIST         ("savetrackpl", true, List.of("stpl"),         PLAYLIST,    SAVE_TRACK_PLAYLIST_COMMAND_DESC,           PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
    SET_PLAYLIST_VISIBILITY     ("plvisiblity", true, List.of("plvis"),        PLAYLIST,    SET_PLAYLIST_VISIBILITY_COMMAND_DESC,       PLAYLIST_ID_OR_NAME_WITH_VISIBILITY_ARG_SYNTAX),
    SHOW_MEMBER_PLAYLISTS       ("showmempl",   true, List.of("smmpl"),        PLAYLIST,    SHOW_MEMBER_PLAYLISTS_COMMAND_DESC,         MEMBER_TAG_ARG_SYNTAX),
    SHOW_MY_PLAYLISTS           ("showmypl",    true, List.of("smpl"),         PLAYLIST,    SHOW_MY_PLAYLISTS_COMMAND_DESC),
    SHOW_PLAYLIST_CONTENT       ("showplsongs", true, List.of("splsg"),        PLAYLIST,    SHOW_PLAYLIST_SONGS_COMMAND_DESC,           PLAYLIST_ID_OR_NAME_ARG_SYNTAX),
