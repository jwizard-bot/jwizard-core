...
enum class I18nMiscLocale(
	...
	VOTING_PERCENTAGE_RATIO("pl.jwizard.system.votingPercentageRatio"),
	VOTE_MAX_WAITING_TIME("pl.jwizard.system.voteMaxWaitingTime"),
	MUSIC_TEXT_CHANNEL("pl.jwizard.system.musicTextChannel"),
	DJ_ROLE_NAME("pl.jwizard.system.djRole"),
	MAX_REPEATS_OF_TRACK("pl.jwizard.system.maxRepeatsOfTrack"),
	LEAVE_EMPTY_CHANNEL_SEC("pl.jwizard.system.leaveEmptyChannelSec"),
	LEAVE_NO_TRACKS_SEC("pl.jwizard.system.leaveNoTracksSec"),
	DEFAULT_VOLUME("pl.jwizard.system.defaultVolume"),
	RANDOM_AUTO_CHOOSE_TRACK("pl.jwizard.system.randomAutoChooseTrack"),
	TIME_AFTER_AUTO_CHOOSE_SEC("pl.jwizard.system.timeAfterAutoChooseTrack"),
	MAX_TRACKS_TO_CHOOSE("pl.jwizard.system.maxTracksToChoose"),
